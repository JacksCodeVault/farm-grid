...
exports.createRegion = async (req, res) => {
  ...
  try {
    await db('regions').insert({ name, is_active: true });
...
exports.getRegions = async (req, res) => {
  try {
    const regions = await db('regions').select('id', 'name', 'is_active');
...
exports.getRegionById = async (req, res) => {
  try {
    const { id } = req.params;
    const region = await db('regions').where({ id }).select('id', 'name', 'is_active').first();
...
exports.updateRegion = async (req, res) => {
  ...
  try {
    ...
    await db('regions').where({ id }).update({
      ...
      is_active: is_active !== undefined ? is_active : regionToUpdate.is_active,
...
exports.createDistrict = async (req, res) => {
  ...
  try {
    await db('districts').insert({ name, region_id, is_active: true });
...
exports.getDistricts = async (req, res) => {
  try {
    const districts = await db('districts').select('id', 'name', 'region_id', 'is_active');
...
exports.getDistrictById = async (req, res) => {
  try {
    const { id } = req.params;
    const district = await db('districts').where({ id }).select('id', 'name', 'region_id', 'is_active').first();
...
exports.updateDistrict = async (req, res) => {
  ...
  try {
    ...
    await db('districts').where({ id }).update({
      ...
      is_active: is_active !== undefined ? is_active : districtToUpdate.is_active,
      updated_at: db.fn.now()
    });
...
exports.createVillage = async (req, res) => {
  ...
  try {
    await db('villages').insert({ name, district_id, is_active: true });
...
exports.getVillages = async (req, res) => {
  try {
    const villages = await db('villages').select('id', 'name', 'district_id', 'is_active');
...
exports.getVillageById = async (req, res) => {
  try {
    const { id } = req.params;
    const village = await db('villages').where({ id }).select('id', 'name', 'district_id', 'is_active').first();
...
exports.updateVillage = async (req, res) => {
  ...
  try {
    ...
    await db('villages').where({ id }).update({
      ...
      is_active: is_active !== undefined ? is_active : villageToUpdate.is_active,
      updated_at: db.fn.now()
    });
